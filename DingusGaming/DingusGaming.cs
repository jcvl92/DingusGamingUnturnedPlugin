...
//TODO: color text(red error messages, blue party chat, etc.)?
//TODO: add reporting so that we can see people using the commands?
namespace DingusGaming
{
    ...
    public class UniversalPlayerComponent : UnturnedPlayerComponent
    {
